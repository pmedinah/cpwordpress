		...
		if ( $posts->have_posts() ) :
			...
			while ( $posts->have_posts() ) : $posts->the_post();
				...
				if ( $instance['show_date'] ) {
					$post_meta .= '<span class="si-posts-list-widget-date"><i class="si-icon si-clock"></i>' . get_the_time( get_option( 'date_format' ) ) . '</span>';
				}
				...
				if ( ! empty( $post_meta ) ) {
					echo '<div class="si-posts-list-widget-meta">' . $post_meta . '</div>';
				}
