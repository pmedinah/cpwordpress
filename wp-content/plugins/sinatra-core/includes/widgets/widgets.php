	...
	<script type="text/template" id="tmpl-sinatra-core-repeatable-item">
		<div class="si-repeatable-item open">
			...
			<div class="si-repeatable-item-title">
				<?php _ex( 'New Item', 'Widget', 'sinatra' ); ?>
			...
			<div class="si-repeatable-item-content">
				...
				<p>
					...
					<input type="text" class="widefat si-icon-picker-input" id="{{data.id}}-{{data.index}}-icon" name="{{data.name}}[{{data.index}}][icon]" placeholder="si-icon si-map-pin"/>
				</p>
				...
				<p>
					...
					<label for="{{data.name}}[{{data.index}}][separator]"><?php _ex( 'Add bottom separator', 'Widget', 'sinatra' ) ?></label>
				</p>
