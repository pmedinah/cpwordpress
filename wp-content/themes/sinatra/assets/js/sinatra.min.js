...
//--------------------------------------------------------------------//
// CUSTOM THEME BY INNOVA
//--------------------------------------------------------------------//
(function () {
  // Social Snap
  	var snap_facebook = document.getElementsByClassName("heateorSssFacebookBackground");
	if (snap_facebook.length > 0){
		snap_facebook[0].setAttribute("onclick", "window.open('https://www.facebook.com/eculturista','_blank');");
		var snap_whatsapp = document.getElementsByClassName("heateorSssWhatsappBackground");
		snap_whatsapp[0].setAttribute("onclick", "window.open('https://api.whatsapp.com/send?phone=593996337854','_blank');");
		snap_whatsapp[0].childNodes[0].removeAttribute("href");
		var snap_instagram = document.getElementsByClassName("heateorSssInstagramBackground");
		snap_instagram[0].setAttribute("onclick", "window.open('https://www.instagram.com/luisgranados78','_blank');");
		snap_instagram[0].childNodes[0].removeAttribute("href");
	}
})();
